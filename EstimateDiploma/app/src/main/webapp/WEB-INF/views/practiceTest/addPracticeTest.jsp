...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <form:form cssClass="form-horizontal" modelAttribute="practiceTest" action="${pageContext.request.contextPath}/admin/practiceTest" method="post">
            <div class="container">
                        ...
                        <fieldset>
                            <div class="control-group">
                                <dl class="dl-horizontal">
                                    ...
                                    <dt>
                                        <label class="control-label pull-left" for="desc">purpose text</label>
                                    </dt>
                                    <dd>
                                        <div class="form-group">
                                            <form:textarea id="purpose" placeholder="Task purpose" path="purposeText"/>
                                        </div>
                                    </dd>
                                    ...
                                    <dd>
                                        <div class="form-group">
                                            <div class="col-lg-1" style="margin-left:15px">
                                                <button type="submit" class="btn btn-success pull-right" >Create practice task
                                                </button>
                                            </div>
                                        </div>
                                    </dd>
